...
class GameRepository {
  ...
  Future<List<GameModel>> searchGames(GameSearchParams params) async {
    ...
    for (var i = 0; i < list.length; i++) {
      final raw = list[i];
      // ignore: avoid_print
      print('[BB][searchGames] index=$i raw.runtimeType=${raw.runtimeType} raw=$raw');
      ...
      if (raw is Map<String, dynamic>) {
        ...
        // ignore: avoid_print
        print('[BB][searchGames] game[$i] organizer.runtimeType=${organizer.runtimeType} value=$organizer');
        // ignore: avoid_print
        print('[BB][searchGames] game[$i] location.runtimeType=${location.runtimeType} value=$location');
        // ignore: avoid_print
        print('[BB][searchGames] game[$i] groupChat.runtimeType=${groupChat.runtimeType} value=$groupChat');
        // ignore: avoid_print
        print('[BB][searchGames] game[$i] sport.runtimeType=${sport.runtimeType} value=$sport');
      } else {
        // ignore: avoid_print
        print('[BB][searchGames] game[$i] is not a Map, skipping field-level debug');
      }
  ...
  Future<GameModel> getGame(String id) async {
    ...
    // ignore: avoid_print
    print('[BB][getGame] groupChat.runtimeType=${groupChat.runtimeType} value=$groupChat');
    // ignore: avoid_print
    print('[BB][getGame] organizer.runtimeType=${organizer.runtimeType} value=$organizer');
    // ignore: avoid_print
    print('[BB][getGame] location.runtimeType=${location.runtimeType} value=$location');
    // ignore: avoid_print
    print('[BB][getGame] result.runtimeType=${result.runtimeType} value=$result');
